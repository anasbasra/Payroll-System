<?php
  ...
  $employeeResult = $conn->query($query);
...
<tr>
    ...
    <td align="center"><a href="view_employee.php?emp_id=<?php echo $row["emp_id"]; ?>" style="text-decoration:none; color: #0b3f75;" title="Update"><?php echo $row['contact'] ?></a></td>
    <td align="center"><a href="view_employee.php?emp_id=<?php echo $row["emp_id"]; ?>" style="text-decoration:none; color: #0b3f75;" title="Update"><?php echo $row['email'] ?></a></td>
