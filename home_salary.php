...
<?php
  $conn = new mysqli('localhost', 'root', '', 'payroll_s');
...
$salary_rate = 0; // Initialize salary_rate
while ($row = $result->fetch_assoc()) {
...
while ($row = $result->fetch_assoc()) {
    ...
    $over = $overtime * $rate; // Calculate overtime pay
    $income = $over + $bonus + $salary_rate; // Total income
    $netpay = $income - $deduction; // Net pay
?>
    <tr>
        <td align="center"><?php echo htmlspecialchars($fname) . ' ' . htmlspecialchars($lname); ?></td>
        <td align="center"><big><b><?php echo htmlspecialchars($overtime); ?></b></big> hrs</td>
        <td align="center"><big><b><?php echo htmlspecialchars($bonus); ?></b></big>.00</td>
        <td align="center"><big><b><?php echo htmlspecialchars($deduction); ?></b></big>.00</td>
        <td align="center"><big><b><?php echo 'Rs. ' . htmlspecialchars($netpay); ?></b></big>.00</td>
    </tr>
<?php
}
?>
