...
// Prepare the SQL statement to fetch deductions
$sql = "SELECT * FROM deductions WHERE deduction_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $deduction_id); // Assuming deduction_id is an integer
$deduction_id = 1; // Set the deduction_id you want to fetch
$stmt->execute();
